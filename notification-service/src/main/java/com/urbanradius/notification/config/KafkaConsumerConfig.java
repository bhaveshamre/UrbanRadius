package com.urbanradius.notification.config;
...
public class KafkaConsumerConfig {
    ...
    ConsumerFactory<String, BookingEvent> bookingEventConsumerFactory(
        ...
        jsonDeserializer.addTrustedPackages("com.urbanradius.common.events");
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, BookingEvent> bookingEventKafkaListenerContainerFactory(
            ConsumerFactory<String, BookingEvent> bookingEventConsumerFactory) {
